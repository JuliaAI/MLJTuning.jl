...
MLJBase.predict(wens::WrappedEnsemble{R,Atom},
...
function MLJBase.predict(wens::WrappedEnsemble,
                 atomic_weights,
                 Xnew,
...
function MLJBase.predict(wens::WrappedEnsemble, atomic_weights, Xnew,
...
function MLJBase.fit(model::EitherEnsembleModel{Atom},
...
function MLJBase.predict(model::EitherEnsembleModel, fitresult, Xnew)
